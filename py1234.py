User
ubah menjadi tidak menggunakan selenium dan ubah menjadi request 
...
excel_file_path = "C:\\Users\\Admin\\Documents\\pysc\\excels\\2020A.xlsx"

# Define the index of the column containing the URLs (assuming it's the second column)
url_column_index = 2
url_column_catatan = 7
...
excel_export_path = "C:\\Users\\Admin\\Documents\\pysc\\excels\\2021_BELUM_LULUS_result.xlsx"
...
while export_file_exists:
    try:
        ...
        export_file_counter += 1
        excel_export_path = f"C:\\Users\\Admin\\Documents\\pysc\\excels\\2021_BELUM_LULUS_result_{export_file_counter}.xlsx"
